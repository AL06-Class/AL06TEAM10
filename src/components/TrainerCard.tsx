...
export default function TrainerCard({ trainer, recommended }: TrainerCardProps) {
  return (
    <li className="relative rounded-lg border border-[#d9dee7] bg-white p-5 shadow-[0_4px_16px_rgba(23,32,42,0.06)]">
      {recommended && (
      ...
      <p className="mt-3 text-sm leading-[1.5] text-ink">{trainer.aiSummary}</p>
